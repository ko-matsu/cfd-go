...
func (p *PegoutService) createPegoutTx(
	...
	for i := 0; i <= loopLimit; i++ {
		...
		outputTx, _, _, calcFee, err = cfd.CfdGoFundRawTransactionAndCalcFee(p.network.ToCfdValue(), txHex, fundTxInList, fundUtxoList, targetAmounts, fundOption)
		if err == nil {
			break
		} else if i == loopLimit {

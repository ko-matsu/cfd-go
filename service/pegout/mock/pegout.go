...
//
//	mockgen -source pegout.go -destination mock/pegout.go -package mock
//
...
func (mr *MockPegoutMockRecorder) ContainsPakEntry(pakEntry, whitelist any) *gomock.Call {
...
func (mr *MockPegoutMockRecorder) CreatePakEntry(accountExtPubkey, onlinePrivkey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPegoutMockRecorder) CreatePegoutAddress(addressType, accountExtPubkey, addressIndex any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPegoutMockRecorder) CreatePegoutTransaction(utxoList, pegoutData, sendList, changeAddress, option any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPegoutMockRecorder) VerifyPubkeySignature(proposalTx, utxoData, signature any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

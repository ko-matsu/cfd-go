...
//go:generate go run go.uber.org/mock/mockgen@v0.4.0 -source pegin.go -destination mock/pegin.go -package mock
//go:generate go run golang.org/x/tools/cmd/goimports@v0.17.0 -w mock/pegin.go

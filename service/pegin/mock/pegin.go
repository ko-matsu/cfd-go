...
//
//	mockgen -source pegin.go -destination mock/pegin.go -package mock
//
...
func (mr *MockPeginMockRecorder) CreatePeginAddress(addressType, pubkey, fedpegScript any) *gomock.Call {
...
func (mr *MockPeginMockRecorder) CreatePeginTransaction(peginOutPoint, peginData, utxoList, sendList, changeAddress, option any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPeginMockRecorder) GetPeginUtxoData(proposalTx, peginOutPoint, pubkey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPeginMockRecorder) GetPubkeyFromAccountExtPubkey(accountExtPubkey, bip32Path any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPeginMockRecorder) VerifyPubkeySignature(proposalTx, utxoData, signature any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

...
func TestSchnorrApi(t *testing.T) {
	...
	assert.NoError(t, err)
	pubkey, err := NewByteDataFromHex("02b33cc9edc096d0a83416964bd3c6247b8fecd256e4efa7870d2c854bdeb33390")
	assert.NoError(t, err)
	...
	assert.NoError(t, err)
	assert.Equal(t, "f14d7e54ff58c5d019ce9986be4a0e8b7d643bd08ef2cdf1099e1a457865b5477c988c51634a8dc955950a58ff5dc8c506ddb796121e6675946312680c26cf33", signature.ToHex())

	signatureWithNonce, err := obj.SignWithNonce(msg, sk, nonce)
	assert.NoError(t, err)
	assert.Equal(t, "5da618c1936ec728e5ccff29207f1680dcf4146370bdcfab0039951b91e3637a50a2a860b130d009405511c3eafe943e157a0df2c2020e3e50df05adb175332f", signatureWithNonce.ToHex())

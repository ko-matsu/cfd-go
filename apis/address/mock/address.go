...
//
//	mockgen -source address.go -destination mock/address.go -package mock
//
...
func (mr *MockAddressApiMockRecorder) CreateByPubkey(pubkey, addressType any) *gomock.Call {
...
func (mr *MockAddressApiMockRecorder) CreateByScript(redeemScript, addressType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAddressApiMockRecorder) CreateMultisigAddress(pubkeys, requireNum, addressType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAddressApiMockRecorder) ParseAddress(addressString any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// CreateByPubkey indicates an expected call of CreateByPubkey.
func (mr *MockElementsAddressApiMockRecorder) CreateByPubkey(pubkey, addressType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// CreateByScript indicates an expected call of CreateByScript.
func (mr *MockElementsAddressApiMockRecorder) CreateByScript(redeemScript, addressType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// CreateMultisigAddress indicates an expected call of CreateMultisigAddress.
func (mr *MockElementsAddressApiMockRecorder) CreateMultisigAddress(pubkeys, requireNum, addressType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockElementsAddressApiMockRecorder) GetPeginAddressByPubkey(addressType, fedpegScript, pubkey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockElementsAddressApiMockRecorder) GetPegoutAddress(addressType, descriptorOrXpub, bip32Counter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// ParseAddress indicates an expected call of ParseAddress.
func (mr *MockElementsAddressApiMockRecorder) ParseAddress(addressString any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

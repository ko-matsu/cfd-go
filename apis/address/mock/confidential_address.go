...
//
//	mockgen -source confidential_address.go -destination mock/confidential_address.go -package mock
//
...
func (mr *MockConfidentialAddressApiMockRecorder) Create(addressString, confidentialKey any) *gomock.Call {
...
func (mr *MockConfidentialAddressApiMockRecorder) Parse(addressString any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

...
//go:generate go run go.uber.org/mock/mockgen@v0.2.0 -source confidential_address.go -destination mock/confidential_address.go -package mock
//go:generate go run golang.org/x/tools/cmd/goimports@v0.12.0 -w mock/confidential_address.go

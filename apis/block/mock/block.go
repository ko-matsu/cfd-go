...
//
//	mockgen -source block.go -destination mock/block.go -package mock
//
...
func (mr *MockBlockApiMockRecorder) ExistTxid(block, txid any) *gomock.Call {
...
func (mr *MockBlockApiMockRecorder) GetHeaderData(block any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBlockApiMockRecorder) GetTransactionData(block, txid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBlockApiMockRecorder) GetTxCount(block any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBlockApiMockRecorder) GetTxidList(block any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

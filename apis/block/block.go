...
//go:generate go run go.uber.org/mock/mockgen@v0.4.0 -source block.go -destination mock/block.go -package mock
//go:generate go run golang.org/x/tools/cmd/goimports@v0.17.0 -w mock/block.go

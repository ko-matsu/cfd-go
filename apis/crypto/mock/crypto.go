...
//
//	mockgen -source crypto.go -destination mock/crypto.go -package mock
//
...
func (mr *MockCryptoApiMockRecorder) DecodeBase58(base58, useChecksum any) *gomock.Call {
...
func (mr *MockCryptoApiMockRecorder) DecodeBase64(base64 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCryptoApiMockRecorder) DecryptAES(key, cbcIv, buffer any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCryptoApiMockRecorder) EncodeBase58(buffer, useChecksum any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCryptoApiMockRecorder) EncodeBase64(buffer any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCryptoApiMockRecorder) EncryptAES(key, cbcIv, buffer any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCryptoApiMockRecorder) Hash160(message, hasText any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCryptoApiMockRecorder) Hash256(message, hasText any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCryptoApiMockRecorder) Ripemd160(message, hasText any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCryptoApiMockRecorder) Sha256(message, hasText any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

...
//go:generate go run go.uber.org/mock/mockgen@v0.4.0 -source descriptor.go -destination mock/descriptor.go -package mock
//go:generate go run golang.org/x/tools/cmd/goimports@v0.17.0 -w mock/descriptor.go

...
//
//	mockgen -source descriptor.go -destination mock/descriptor.go -package mock
//
...
func (mr *MockDescriptorApiMockRecorder) GetChecksum(descriptor any) *gomock.Call {
...
func (mr *MockDescriptorApiMockRecorder) NewDescriptorFromAddress(address any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDescriptorApiMockRecorder) NewDescriptorFromExtPubkey(hashType, extPubkey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDescriptorApiMockRecorder) NewDescriptorFromLockingScript(lockingScript any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDescriptorApiMockRecorder) NewDescriptorFromMultisig(hashType, pubkeys, requireNum any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDescriptorApiMockRecorder) NewDescriptorFromPubkey(hashType, pubkey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDescriptorApiMockRecorder) NewDescriptorFromString(descriptor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDescriptorApiMockRecorder) Parse(descriptor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDescriptorApiMockRecorder) ParseByFilter(descriptor, filter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDescriptorApiMockRecorder) ParseByFilterWithDerivationPath(descriptor, bip32DerivationPath, filter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDescriptorApiMockRecorder) ParseByString(descriptor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDescriptorApiMockRecorder) ParseWithDerivationPath(descriptor, bip32DerivationPath any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

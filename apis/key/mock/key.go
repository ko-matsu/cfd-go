...
//
//	mockgen -source key.go -destination mock/key.go -package mock
//
...
func (mr *MockPubkeyApiMockRecorder) IsCompressed(pubkey any) *gomock.Call {
...
func (mr *MockPubkeyApiMockRecorder) Verify(pubkey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPubkeyApiMockRecorder) VerifyEcSignature(pubkey, sighash, signature any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPubkeyApiMockRecorder) VerifyMessage(pubkey, signature, message, magic any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPrivkeyApiMockRecorder) CreateEcSignature(privkey, sighash, sighashType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPrivkeyApiMockRecorder) CreateEcSignatureGrindR(privkey, sighash, sighashType, grindR any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPrivkeyApiMockRecorder) GetPrivkeyFromWif(wif any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPrivkeyApiMockRecorder) GetPubkey(privkey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPrivkeyApiMockRecorder) GetWifFromHex(privkeyHex any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPrivkeyApiMockRecorder) GetWifFromHexWithCompressedPubkey(privkeyHex, compressedPubkey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPrivkeyApiMockRecorder) HasWif(wif any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPrivkeyApiMockRecorder) SignMessage(privkey, message, magic, isOutputBase64 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

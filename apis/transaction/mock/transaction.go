...
func (mr *MockTransactionApiMockRecorder) Add(tx, txinList, txoutList any) *gomock.Call {
...
func (mr *MockTransactionApiMockRecorder) AddPubkeySign(tx, outpoint, hashType, pubkey, signature any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTransactionApiMockRecorder) AddPubkeySignByDescriptor(tx, outpoint, outputDescriptor, signature any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTransactionApiMockRecorder) Create(version, locktime, txinList, txoutList any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTransactionApiMockRecorder) GetTxOut(tx, vout any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTransactionApiMockRecorder) GetTxid(tx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTransactionApiMockRecorder) SignWithPrivkey(tx, outpoint, privkey, sighashType, utxoList any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTransactionApiMockRecorder) VerifySign(tx, outpoint, amount, txinUtxoList any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

...
//
//	mockgen -source ledger_liquid_lib.go -destination mock/ledger_liquid_lib.go -package mock
//
...
func (mr *MockLedgerLiquidLibApiMockRecorder) GetAuthorizeSignature(tx, key any) *gomock.Call {
